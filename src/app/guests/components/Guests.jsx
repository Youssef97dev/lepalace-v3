...
const Guests = () => {
  ...
  return (
    <div className="relative w-full h-screen">
      <Image
        src="https://res.cloudinary.com/dz7wroord/image/upload/f_auto,q_auto/v1/palace/mmcsecoxamxqd8azk4cv"
        alt={`Guests Page`}
        layout="fill"
        objectFit="cover"
      ...
      <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
        <div className="w-full flex flex-col justify-center items-center gap-5 text-white">
          <img src="/palace-logo.png" alt="Logo" className="mb-4 w-44 h-44" />
